...
class Topologias extends OracleDB {
    ...
    public function getAllSites () {
        $sql = "SELECT DISTINCT SITE_NOMBRE FROM (SELECT DISTINCT SOURCE_SITE AS SITE_NOMBRE FROM DVL_ENLACES UNION SELECT DISTINCT SINK_SITE AS SITE_NOMBRE FROM DVL_ENLACES) WHERE SITE_NOMBRE IS NOT NULL ORDER BY SITE_NOMBRE";
        self::ejecutar($sql);
        return self::$results;
    }
